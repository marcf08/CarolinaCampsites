...
! function(e, t) {
  ...
  return function(e) {
    ...
    var o = n(1),
      ...
      l = function() {
        function e(t) {
          s(this, e), this.N = new a.default(u, 16), this.g = new a.default("2", 16), this.k = new a.default(this.hexHash("00" + this.N.toString(16) + "0" + this.g.toString(16)), 16), this.smallAValue = this.generateRandomSmallA(), this.getLargeAValue(function() {}), this.infoBits = new o.util.Buffer("Caldera Derived Key", "utf8"), this.poolName = t
        }
        return e.prototype.getSmallAValue = function() {
          ...
          this.SaltToHashDevices = this.padHex(new a.default(u, 16)), this.g.modPow(new a.default(this.hexHash(this.SaltToHashDevices + r), 16), this.N, function(e, t) {
          ...
          this.g.modPow(e, this.N, function(e, i) {
            e && t(e, null), i.mod(n.N).equals(a.default.ZERO) && t(new Error("Illegal paramater. A mod N cannot be 0."), null), t(null, i)
          })
          ...
          var r = this;
          if (n.mod(this.N).equals(a.default.ZERO)) throw new Error("B cannot be zero.");
          if (this.UValue = this.calculateU(this.largeAValue, n), this.UValue.equals(a.default.ZERO)) throw new Error("U cannot be zero.");
    ...
    function o(e, t, n, i, s, o) {
      for (var r = 32767 & t, a = t >> 15; --o >= 0;) {
        var u = 32767 & this[e],
          c = this[e++] >> 15,
          l = a * u + c * r;
        u = r * u + ((32767 & l) << 15) + n[i] + (1073741823 & s), s = (u >>> 30) + (l >>> 15) + a * c + (s >>> 30), n[i++] = 1073741823 & u
      }
      return s
    }
    ...
    function r(e, t, n, i, s, o) {
      for (var r = 16383 & t, a = t >> 14; --o >= 0;) {
        var u = 16383 & this[e],
          c = this[e++] >> 14,
          l = a * u + c * r;
        u = r * u + ((16383 & l) << 14) + n[i] + s, s = (u >> 28) + (l >> 14) + a * c, n[i++] = 268435455 & u
      }
      return s
    }
    ...
    function f(e, t) {
      ...
      for (var s = e.length, o = !1, r = 0; --s >= 0;) {
        var a = u(e, s);
        a < 0 ? "-" == e.charAt(s) && (o = !0) : (o = !1, 0 == r ? this[this.t++] = a : r + i > this.DB ? (this[this.t - 1] |= (a & (1 << this.DB - r) - 1) << r, this[this.t++] = a >> this.DB - r) : this[this.t - 1] |= a << r, r += i, r >= this.DB && (r -= this.DB))
      }
    ...
    function p(e) {
      ...
      if (r-- > 0)
        for (u < this.DB && (n = this[r] >> u) > 0 && (s = !0, o = a(n)); r >= 0;) u < t ? (n = (this[r] & (1 << u) - 1) << t - u, n |= this[--r] >> (u += this.DB - t)) : (n = this[r] >> (u -= t) & i, u <= 0 && (u += this.DB, --r)), n > 0 && (s = !0), s && (o += a(n));
      return s ? o : "0"
    }
    ...
    function A(e, t) {
      var n, i = e % this.DB,
        ...
        a = this.s << i & this.DM;
      for (n = this.t - 1; n >= 0; --n) t[n + r + 1] = this[n] >> s | a, a = (this[n] & o) << i;
    ...
    function w(e, t) {
      ...
      var i = e % this.DB,
        ...
        o = (1 << i) - 1;
      t[0] = this[n] >> i;
      for (var r = n + 1; r < this.t; ++r) t[r - n - 1] |= (this[r] & o) << s, t[r - n] = this[r] >> i;
    ...
    function I(e, t, s) {
      ...
      if (!(o.t <= 0)) {
        var r = this.abs();
        if (r.t < o.t) return null != t && t.fromInt(0), void(null != s && this.copyTo(s));
        null == s && (s = i());
        var a = i(),
          u = this.s,
          c = e.s,
        ...
        if (0 != f) {
          var d = f * (1 << this.F1) + (h > 1 ? a[h - 2] >> this.F2 : 0),
            ...
            C = S - h,
            y = null == t ? i() : t;
          for (a.dlShiftTo(C, y), s.compareTo(y) >= 0 && (s[s.t++] = 1, s.subTo(y, s)), n.ONE.dlShiftTo(h, y), y.subTo(a, a); a.t < h;) a[a.t++] = 0;
          for (; --C >= 0;) {
            var U = s[--S] == f ? this.DM : Math.floor(s[S] * p + (s[S - 1] + v) * g);
            if ((s[S] += a.am(0, U, s, C, 0, h)) < U)
              for (a.dlShiftTo(C, y), s.subTo(y, s); s[S] < --U;) s.subTo(y, s)
          }
          null != t && (s.drShiftTo(h, t), u != c && n.ZERO.subTo(t, t)), s.t = h, s.clamp(), l > 0 && s.rShiftTo(l, s), u < 0 && n.ZERO.subTo(s, s)
        }
      }
    }
    ...
    function j(e, t, n) {
      ...
      if (u[1] = a.convert(this), s > 1) {
        var d = i();
        for (a.sqrTo(u[1], d); c <= f;) u[c] = i(), a.mulTo(d, u[c - 2], u[c]), c += 2
      }
      var p, g, v = e.t - 1,
        S = !0,
        C = i();
      for (o = m(e[v]) - 1; v >= 0;) {
        for (o >= l ? p = e[v] >> o - l & f : (p = (e[v] & (1 << o + 1) - 1) << l - o, v > 0 && (p |= e[v - 1] >> this.DB + o - l)), c = s; 0 == (1 & p);) p >>= 1, --c;
        if ((o -= c) < 0 && (o += this.DB, --v), S) u[p].copyTo(r), S = !1;
        else {
          for (; c > 1;) a.sqrTo(r, C), a.sqrTo(C, r), c -= 2;
          c > 0 ? a.sqrTo(r, C) : (g = r, r = C, C = g), a.mulTo(C, u[p], r)
        }
        for (; v >= 0 && 0 == (e[v] & 1 << o);) a.sqrTo(r, C), g = r, r = C, C = g, --o < 0 && (o = this.DB - 1, --v)
      }
      var y = a.revert(r);
      return n(null, y), y
    }
    ...
    W && L && "Microsoft Internet Explorer" == navigator.appName ? (n.prototype.am = o, H = 30) : W && L && "Netscape" != navigator.appName ? (n.prototype.am = s, H = 26) : (n.prototype.am = r, H = 28), n.prototype.DB = H, n.prototype.DM = (1 << H) - 1, n.prototype.DV = 1 << H;
    var G = 52;
    n.prototype.FV = Math.pow(2, G), n.prototype.F1 = G - H, n.prototype.F2 = 2 * H - G;
    var Z, Y, z = "0123456789abcdefghijklmnopqrstuvwxyz",
      Q = new Array;
    for (Z = "0".charCodeAt(0), Y = 0; Y <= 9; ++Y) Q[Z++] = Y;
    for (Z = "a".charCodeAt(0), Y = 10; Y < 36; ++Y) Q[Z++] = Y;
    for (Z = "A".charCodeAt(0), Y = 10; Y < 36; ++Y) Q[Z++] = Y;
    N.prototype.convert = B, N.prototype.revert = O, N.prototype.reduce = V, N.prototype.mulTo = q, N.prototype.sqrTo = K, n.prototype.copyTo = c, n.prototype.fromInt = l, n.prototype.fromString = f, n.prototype.clamp = d, n.prototype.dlShiftTo = y, n.prototype.drShiftTo = U, n.prototype.lShiftTo = A, n.prototype.rShiftTo = w, n.prototype.subTo = T, n.prototype.multiplyTo = D, n.prototype.squareTo = E, n.prototype.divRemTo = I, n.prototype.invDigit = R, n.prototype.addTo = P, n.prototype.toString = p, n.prototype.negate = g, n.prototype.abs = v, n.prototype.compareTo = S, n.prototype.bitLength = C, n.prototype.mod = k, n.prototype.equals = F, n.prototype.add = b, n.prototype.subtract = _, n.prototype.multiply = M, n.prototype.divide = x, n.prototype.modPow = j, n.ZERO = h(0), n.ONE = h(1)
  }, function(e, t, n) {
    "use strict";
    ...
    var o = n(1),
      ...
      T = function() {
        function e(t) {
          ...
          this.username = t.Username || "", this.pool = t.Pool, this.Session = null, this.client = t.Pool.client, this.signInUserSession = null, this.authenticationFlowType = "USER_SRP_AUTH", this.storage = t.Storage || (new w.default).getStorage()
        }
        return e.prototype.setSignInUserSession = function(e) {
          ...
          this.getUserContextData() && (s.UserContextData = this.getUserContextData()), this.client.makeUnauthenticatedRequest("initiateAuth", s, function(e, i) {
            if (e) return t.onFailure(e);
            var s = i.ChallengeName,
              o = i.ChallengeParameters;
            return "CUSTOM_CHALLENGE" === s ? (n.Session = i.Session, t.customChallenge(o)) : (n.signInUserSession = n.getCognitoUserSession(i.AuthenticationResult), n.cacheTokens(), t.onSuccess(n.signInUserSession))
          })
          ...
          var n = this,
            ...
            u = void 0,
            l = {};
          null != this.deviceKey && (l.DEVICE_KEY = this.deviceKey), l.USERNAME = this.username, i.getLargeAValue(function(c, h) {
            c && t.onFailure(c), l.SRP_A = h.toString(16), "CUSTOM_AUTH" === n.authenticationFlowType && (l.CHALLENGE_NAME = "SRP_A");
            var f = {
            ...
            n.getUserContextData(n.username) && (f.UserContextData = n.getUserContextData(n.username)), n.client.makeUnauthenticatedRequest("initiateAuth", f, function(c, l) {
              if (c) return t.onFailure(c);
              var h = l.ChallengeParameters;
              n.username = h.USER_ID_FOR_SRP, r = new a.default(h.SRP_B, 16), u = new a.default(h.SALT, 16), n.getCachedDeviceKeyAndPassword(), i.getPasswordAuthenticationKey(n.username, e.getPassword(), r, u, function(e, r) {
                e && t.onFailure(e);
                var a = s.getNowString(),
                  ...
                  c = {};
                c.USERNAME = n.username, c.PASSWORD_CLAIM_SECRET_BLOCK = h.SECRET_BLOCK, c.TIMESTAMP = a, c.PASSWORD_CLAIM_SIGNATURE = u, null != n.deviceKey && (c.DEVICE_KEY = n.deviceKey);
                var f = function e(t, i) {
                    return n.client.makeUnauthenticatedRequest("respondToAuthChallenge", t, function(s, o) {
                      return s && "ResourceNotFoundException" === s.code && s.message.toLowerCase().indexOf("device") !== -1 ? (c.DEVICE_KEY = null, n.deviceKey = null, n.randomPassword = null, n.deviceGroupKey = null, n.clearCachedDeviceKeyAndPassword(), e(t, i)) : i(s, o)
                    })
                  },
                  d = {
                ...
                n.getUserContextData() && (d.UserContextData = n.getUserContextData()), f(d, function(e, s) {
                  if (e) return t.onFailure(e);
                  ...
                  if ("NEW_PASSWORD_REQUIRED" === o) {
                    ...
                    if (s.ChallengeParameters && (r = JSON.parse(s.ChallengeParameters.userAttributes), a = JSON.parse(s.ChallengeParameters.requiredAttributes)), a)
          ...
          if ("SELECT_MFA_TYPE" === s) return this.Session = e.Session, n.selectMFAType(s, r);
          if ("MFA_SETUP" === s) return this.Session = e.Session, n.mfaSetup(s, r);
          if ("SOFTWARE_TOKEN_MFA" === s) return this.Session = e.Session, n.totpRequired(s, r);
          ...
          return null == a ? n.onSuccess(this.signInUserSession) : void t.generateHashDevice(e.AuthenticationResult.NewDeviceMetadata.DeviceGroupKey, e.AuthenticationResult.NewDeviceMetadata.DeviceKey, function(s) {
            ...
            i.verifierDevices = r.PasswordVerifier, i.deviceGroupKey = a.DeviceGroupKey, i.randomPassword = t.getRandomPassword(), i.client.makeUnauthenticatedRequest("confirmDevice", {
          ...
          this.getUserContextData() && (a.UserContextData = this.getUserContextData()), this.client.makeUnauthenticatedRequest("respondToAuthChallenge", a, function(e, t) {
          ...
          var t = this,
            ...
            i = new C.default,
            s = {};
          s.USERNAME = this.username, s.DEVICE_KEY = this.deviceKey, n.getLargeAValue(function(r, u) {
            ...
            t.getUserContextData() && (c.UserContextData = t.getUserContextData()), t.client.makeUnauthenticatedRequest("respondToAuthChallenge", c, function(s, r) {
              ...
              n.getPasswordAuthenticationKey(t.deviceKey, t.randomPassword, c, l, function(n, s) {
                ...
                var a = i.getNowString(),
                  ...
                  l = {};
                l.USERNAME = t.username, l.PASSWORD_CLAIM_SECRET_BLOCK = u.SECRET_BLOCK, l.TIMESTAMP = a, l.PASSWORD_CLAIM_SIGNATURE = c, l.DEVICE_KEY = t.deviceKey;
                var h = {
                ...
                t.getUserContextData() && (h.UserContextData = t.getUserContextData()), t.client.makeUnauthenticatedRequest("respondToAuthChallenge", h, function(n, i) {
          ...
          this.getUserContextData() && (i.UserContextData = this.getUserContextData()), this.client.makeUnauthenticatedRequest("confirmSignUp", i, function(e) {
          ...
          this.getUserContextData() && (o.UserContextData = this.getUserContextData()), this.client.makeUnauthenticatedRequest("respondToAuthChallenge", o, function(e, i) {
          ...
          var r = n || "SMS_MFA";
          "SOFTWARE_TOKEN_MFA" === r && (s.SOFTWARE_TOKEN_MFA_CODE = e), null != this.deviceKey && (s.DEVICE_KEY = this.deviceKey);
          var a = {
            ChallengeName: r,
            ChallengeResponses: s,
            ClientId: this.pool.getClientId(),
          ...
          this.getUserContextData() && (a.UserContextData = this.getUserContextData()), this.client.makeUnauthenticatedRequest("respondToAuthChallenge", a, function(e, n) {
            if (e) return t.onFailure(e);
            ...
            r.generateHashDevice(n.AuthenticationResult.NewDeviceMetadata.DeviceGroupKey, n.AuthenticationResult.NewDeviceMetadata.DeviceKey, function(e) {
              ...
              i.verifierDevices = s.PasswordVerifier, i.deviceGroupKey = n.AuthenticationResult.NewDeviceMetadata.DeviceGroupKey, i.randomPassword = r.getRandomPassword(), i.client.makeUnauthenticatedRequest("confirmDevice", {
                DeviceKey: n.AuthenticationResult.NewDeviceMetadata.DeviceKey,
                AccessToken: i.signInUserSession.getAccessToken().getJwtToken(),
                DeviceSecretVerifierConfig: s,
                DeviceName: navigator.userAgent
              }, function(e, s) {
                return e ? t.onFailure(e) : (i.deviceKey = n.AuthenticationResult.NewDeviceMetadata.DeviceKey, i.cacheDeviceKeyAndPassword(), s.UserConfirmationNecessary === !0 ? t.onSuccess(i.signInUserSession, s.UserConfirmationNecessary) : t.onSuccess(i.signInUserSession))
              })
            })
          })
          ...
          this.getUserContextData() && (a.UserContextData = this.getUserContextData()), this.client.makeUnauthenticatedRequest("initiateAuth", a, function(i, s) {
          ...
          var e = "CognitoIdentityServiceProvider." + this.pool.getClientId(),
            ...
            o = e + ".LastAuthUser";
          this.storage.setItem(t, this.signInUserSession.getIdToken().getJwtToken()), this.storage.setItem(n, this.signInUserSession.getAccessToken().getJwtToken()), this.storage.setItem(i, this.signInUserSession.getRefreshToken().getToken()), this.storage.setItem(s, "" + this.signInUserSession.getClockDrift()), this.storage.setItem(o, this.username)
          ...
          this.getUserContextData() && (t.UserContextData = this.getUserContextData()), this.client.makeUnauthenticatedRequest("forgotPassword", t, function(t, n) {
          ...
          this.getUserContextData() && (i.UserContextData = this.getUserContextData()), this.client.makeUnauthenticatedRequest("confirmForgotPassword", i, function(e) {
          ...
          this.getUserContextData() && (s.UserContextData = this.getUserContextData()), this.client.makeUnauthenticatedRequest("respondToAuthChallenge", s, function(i, s) {
            return i ? t.onFailure(i) : (n.Session = s.Session, "SMS_MFA" === e ? t.mfaRequired(s.challengeName, s.challengeParameters) : "SOFTWARE_TOKEN_MFA" === e ? t.totpRequired(s.challengeName, s.challengeParameters) : void 0)
          })
          ...
          null != this.signInUserSession && this.signInUserSession.isValid() ? this.client.makeUnauthenticatedRequest("associateSoftwareToken", {
            ...
            return n ? e.onFailure(n) : (t.Session = i.Session, e.associateSecretCode(i.SecretCode))
          })
          ...
          null != this.signInUserSession && this.signInUserSession.isValid() ? this.client.makeUnauthenticatedRequest("verifySoftwareToken", {
            ...
            i.getUserContextData() && (o.UserContextData = i.getUserContextData()), i.client.makeUnauthenticatedRequest("respondToAuthChallenge", o, function(e, t) {
              return e ? n.onFailure(e) : (i.signInUserSession = i.getCognitoUserSession(t.AuthenticationResult), i.cacheTokens(), n.onSuccess(i.signInUserSession))
            })
          })
        }, e
      }();
    ...
    var i = function() {
      function e() {
        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
          ...
          o = t.AccessToken,
          r = t.ClockDrift;
        if (n(this, e), null == o || null == i) throw new Error("Id token and Access Token must be present.");
        this.idToken = i, this.refreshToken = s, this.accessToken = o, this.clockDrift = void 0 === r ? this.calculateClockDrift() : r
      }
    ...
    var i = function() {
      function e(t) {
        ...
        var i = t || {},
          ...
          r = i.Password,
          a = i.AuthParameters;
        this.validationData = s || [], this.authParameters = a || [], this.username = o, this.password = r
      }
    ...
    var o = n(13),
      ...
      h = function() {
        function e(t) {
          ...
          if (!i || !o) throw new Error("Both UserPoolId and ClientId are required.");
          ...
          this.userPoolId = i, this.clientId = o, this.client = new r.default({
            ...
            region: c,
            endpoint: a
          }), this.advancedSecurityDataCollectionFlag = u !== !1, this.storage = t.Storage || (new l.default).getStorage()
        }
        return e.prototype.getUserPoolId = function() {
          ...
          this.getUserContextData(e) && (r.UserContextData = this.getUserContextData(e)), this.client.makeUnauthenticatedRequest("signUp", r, function(t, n) {
    ...
    var o = n(18),
      ...
      a = function() {
        function e(t) {
          s(this, e), this.domain = t.domain, t.path ? this.path = t.path : this.path = "/", Object.prototype.hasOwnProperty.call(t, "expires") ? this.expires = t.expires : this.expires = 365, Object.prototype.hasOwnProperty.call(t, "secure") ? this.secure = t.secure : this.secure = !0
        }
    ...
    ! function(o) {
      var r = !1;
      if (i = o, s = "function" == typeof i ? i.call(t, n, t, e) : i, !(void 0 !== s && (e.exports = s)), r = !0, e.exports = o(), r = !0, !r) {
